...
type Options = {
  pathParams: edit_originality_report_submissionsPathParameters;
  params?: edit_originality_report_submissionsFormParameters;
};
 ...
 */
export async function edit_originality_report_submissions({
  pathParams,
  params
}: Options) {
