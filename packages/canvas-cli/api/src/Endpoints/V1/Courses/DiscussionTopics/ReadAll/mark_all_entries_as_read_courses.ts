...
type mark_all_entries_as_read_coursesPathParameters = {
  /** ID */
  course_id: string;
  /** ID */
  topic_id: string;
...
type mark_all_entries_as_read_coursesFormParameters = {
  /**
 ...
 */
export async function mark_all_entries_as_read_courses({
  pathParams,
  params
}: Options) {
