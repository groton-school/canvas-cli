...
type grade_or_comment_on_multiple_submissions_sections_assignmentsPathParameters =
  {
    /** ID */
    section_id: string;
    /** ID */
...
type grade_or_comment_on_multiple_submissions_sections_assignmentsFormParameters =
  {
    /**
