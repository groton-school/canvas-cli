...
type grade_or_comment_on_multiple_submissions_sections_submissionsPathParameters =
  {
    /** ID */
    section_id: string;
  };

type grade_or_comment_on_multiple_submissions_sections_submissionsFormParameters =
  {
    /**
