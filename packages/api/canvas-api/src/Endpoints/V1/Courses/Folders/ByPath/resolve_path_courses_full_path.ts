...
export type resolve_path_courses_full_pathPathParameters = {
  ...
  /**
   * Identified by @groton/canvas-api.swagger-renderer from the endpoint path: /v1/courses/{course_id}/folders/by_path/*full_path
   *
   *
   *
   *
...
type Options = (
  | {
      path: resolve_path_courses_full_pathPathParameters;
    }
  | {
  ...
  (
    | {
        query?: Partial<resolve_path_courses_full_pathSearchParameters>;
    ...
    | ((
        | {
            query: resolve_path_courses_full_pathSearchParameters;
          }
        | {
            /** @deprecated Use {@link Options.query} */
