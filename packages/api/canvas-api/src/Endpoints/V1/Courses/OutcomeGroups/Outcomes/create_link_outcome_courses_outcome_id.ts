...
export type create_link_outcome_courses_outcome_idPathParameters = {
  /**
   * ID
   *
   * Type: string
...
type Options = (
  ...
  (
    ...
    | ((
        ...
        (
          | {
              body: create_link_outcome_courses_outcome_idFormParameters;
            }
          | {
              /** @deprecated Use {@link Options.body} */
 ...
 */
export async function create_link_outcome_courses_outcome_id(options: Options) {
