...
export type grade_or_comment_on_submission_coursesSearchParameters = Masquerade;
...
type Options = (
  ...
  (
    ...
    | ((
        ...
        (
          | {
              body: grade_or_comment_on_submission_coursesFormParameters;
            }
          | {
              /** @deprecated Use {@link Options.body} */
 ...
 */
export async function grade_or_comment_on_submission_courses(options: Options) {
