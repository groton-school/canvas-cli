...
export type mark_rubric_assessments_as_read_courses_rubric_commentsSearchParameters =
  Masquerade;

type Options = (
  | {
      path: mark_rubric_assessments_as_read_courses_rubric_commentsPathParameters;
    }
  | {
  ...
  (
    | {
        query?: Partial<mark_rubric_assessments_as_read_courses_rubric_commentsSearchParameters>;
        /** @deprecated Use {Options.query} */
        searchParams?: Partial<mark_rubric_assessments_as_read_courses_rubric_commentsSearchParameters>;
        strict?: false;
      }
    | ((
        | {
            query: mark_rubric_assessments_as_read_courses_rubric_commentsSearchParameters;
          }
        | {
            /** @deprecated Use {Options.query} */
            searchParams: mark_rubric_assessments_as_read_courses_rubric_commentsSearchParameters;
          }
      ) & {
        strict: true;
      })
