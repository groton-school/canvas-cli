...
type Options = (
  | {
      path: grade_or_comment_on_multiple_submissions_sections_submissionsPathParameters;
    }
  | {
  ...
  (
    ...
    | ((
        ...
        (
          | {
              body: grade_or_comment_on_multiple_submissions_sections_submissionsFormParameters;
            }
          | {
              /** @deprecated Use {@link Options.body} */
