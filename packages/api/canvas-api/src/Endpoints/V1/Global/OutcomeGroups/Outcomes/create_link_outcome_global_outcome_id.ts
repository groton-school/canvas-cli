...
export type create_link_outcome_global_outcome_idPathParameters = {
  /**
   * ID
   *
   * Type: string
...
type Options = (
  | {
      path: create_link_outcome_global_outcome_idPathParameters;
    }
  | {
  ...
  (
    ...
    | ((
        ...
        (
          | {
              body: create_link_outcome_global_outcome_idFormParameters;
            }
          | {
              /** @deprecated Use {@link Options.body} */
 ...
 */
export async function create_link_outcome_global_outcome_id(options: Options) {
