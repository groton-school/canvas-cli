...
type Options = (
  | {
      path: resolve_path_users_full_pathPathParameters;
    }
  | {
  ...
  (
    | {
        query?: Partial<resolve_path_users_full_pathSearchParameters>;
    ...
    | ((
        | {
            query: resolve_path_users_full_pathSearchParameters;
          }
        | {
            /** @deprecated Use {@link Options.query} */
